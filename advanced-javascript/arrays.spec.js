...
describe('Arrays', () => {
  describe('map', () => {
    ...
    it ('should add number by itself', () => {
      expect(arrayFunctions.map([1,2,3], num => num + num)).toEqual([2,4,6])
    })
  });
  ...
  describe('find', () => {
    ...
    it ('should find number', () => {
      expect(arrayFunctions.map([1,2,3], num => num === '1')).toEqual([false, false, false])
    })
  });
...
``
    it ('should filter number', () => {
      expect(arrayFunctions.map([1,2,3], num => num === 1)).toEqual([true, false, false])
    })
  });
