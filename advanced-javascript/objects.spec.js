...
describe('objects', () => {
  ...
  //values
  describe("values", () => {
    it("should return an array of the values of an object", () => {
  ...
  //mapObject
  describe("mapObject", () => {
    it("return an object with the value increment by 1", () => {
      expect(objectFunctions.mapObject({num1: 5, num2: 7}, (x) => x + 1)).toEqual({num1: 6, num2: 8});
    })
  })

  //pairs
  describe("pairs", () => {
    it("should return 1 with arrays of their key value pair", () => {
      expect(objectFunctions.pairs({name: "Ja", age: 23})).toEqual([["name", "Ja"], ["age", 23]])
    })
  })
  //invert
  describe("invert", () => {
  ...
  describe("default", () => {
    it("should return the object's own property and value and properties that you don't have but is given to you from the default object", () => {
      expect(objectFunctions.defaults({name: "Ja", age: 23}, {name: "test", age: 5, lastName: "Navey"})).toEqual({name: "Ja", age: 23, lastName: "Navey"})
    })
  })
});
