...
describe.skip('project-1 tests', () => {
  describe('multiplyByTen', () => {
    ...
    it('should return null if NaN', () => {
      expect(helpers.multiplyByTen([ 12, 20 ])).toBe(null);
    });
  });
  ...
  describe('subtractFive', () => {
    ...
    it('should return null if NaN', () => {
      expect(helpers.subtractFive('los huevos')).toBe(null);
    });
  });
  ...
  describe('getTriangleArea', () => {
    ...
    it('should return null if NaN', () => {
      expect(helpers.getTriangleArea(2, 'two')).toBe(null);
    });
  });
  ...
  describe('getCircleArea', () => {
    ...
    it('should return null if NaN', () => {
      expect(helpers.getCircleArea('two')).toBe(null);
    });
  });
  ...
  describe('getRectangularPrismVolume', () => {
    ...
    it('should return null if NaN', () => {
      expect(helpers.getRectangularPrismVolume('two', 2, 2)).toBe(null);
    });
  });  
});
