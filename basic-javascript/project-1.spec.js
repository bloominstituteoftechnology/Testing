...
//   it('checks if a decemel number if rounded or not', () => {
//     const actual = funcs.roundNumber(2.5)
//     expect(actual).toEqual(3)
//   })
// })
//
// describe('addExclamationPoint', () => {
//   it('checks if a ! is added the end the string', () => {
//     const total = funcs.addExclamationPoint('string');
//     const actual = total[total.length - 1];
//     expect(actual).toEqual('!')
//   })
// })
//
// describe('combineNames', () => {
//   it('checks if it combines two names', () => {
//     const fullName = funcs.combineNames('imran', 'ahmed');
//     const actual = fullName.split(' ');
//     expect(actual).toContain('imran');
//     expect(actual).toContain('ahmed');
//   })
// })
//
// describe('getGreeting', () => {
//   it('checks for a name at the end of greeting', () => {
//     const result = funcs.getGreeting('imran');
...
//   it('calculates the volume of a rec prism', () => {
//     const actual = funcs.getRectangularPrismVolume(4, 8, 10);
...
//     const result = funcs.getCircleArea(14);
//     const acutal = funcs.roundNumber(result)
//     expect(acutal).toEqual(616)
//   })
// })
