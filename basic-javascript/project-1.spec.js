...
describe('project-1.js', () => {
    ...
    describe('addExclamationPoint()', () => {
      it('should add an exclaimation point to the end of a string', () => {
        const expected = 'yeet!';
        const actual = helpers.addExclamationPoint('yeet');
        expect(actual).toBe(expected);
      });
    });
    describe('combineNames()', () => {
      it('should combine the first and last name', () => {
        const expected = 'David Benavidez';
        const actual = helpers.combineNames('David', 'Benavidez');
        expect(actual).toBe(expected);
      });
    });
    describe('getGreeting()', () => {
      it('should greet the name', () => {
        const expected = 'Hello David Benavidez!';
        const actual = helpers.getGreeting('David Benavidez');
        expect(actual).toBe(expected);
      });
    });
