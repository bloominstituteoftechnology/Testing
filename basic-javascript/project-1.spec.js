...
describe('combineNames', () => {
    it('returns one String with the combined names', () => {
        expect(helpers.combineNames('Bill', 'Taylor')).toBe('Bill Taylor');
        expect(helpers.combineNames('Robot', 123)).toBe('Robot 123');
...
describe('getGreeting', () => {
    it('returns one String with the name inserted into a greeting', () => {
        expect(helpers.getGreeting('Bill')).toBe('Hello Bill!');
        expect(helpers.getGreeting(234)).toBe('Hello 234!');
...
describe('getCircleArea', () => {
    ...
    it('returns NaN provided a non-Number', () => {
        expect(helpers.getCircleArea('pie')).toBeNaN();
    });
});
