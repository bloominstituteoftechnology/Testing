...
describe('project-2', () => {
  ...
  describe('returnLast(arr)', () => {
    it('should return the last item in the array', () => {
      ...
      expect(
        funcs.returnLast(['hi', 'there', 'how', 'are', 'you', 'doing?'])
      ).toBe('doing?');
    });
  });
  ...
  describe('getArrayLength(arr)', () => {
    it('should return the length of the array', () => {
      ...
      expect(
        funcs.getArrayLength(['hi', 'there', 'how', 'are', 'you', 'doing?'])
      ).toBe(6);
    });
  });
  ...
  describe('incrementByOne(arr)', () => {
    it('should return the array with each value incremented by one', () => {
      ...
      expect(funcs.incrementByOne([97, 100, 80, 55, 72, 94])).toEqual([
        98,
        101,
        81,
        56,
  ...
  describe('addItemToArray(arr, item)', () => {
    it('should return the array with the item added to the end', () => {
      expect(funcs.addItemToArray([10, 10, 16, 12], 10)).toEqual([
        10,
        10,
        16,
        12,
      ...
      expect(funcs.addItemToArray([97, 100, 80, 55, 72, 94], 'Hello')).toEqual([
        97,
        100,
        80,
        55,
  ...
  describe('addItemToFront(arr, item)', () => {
    it('should return the array with the item added to the front', () => {
      expect(funcs.addItemToFront([10, 10, 16, 12], 10)).toEqual([
        10,
        10,
        10,
        16,
      ...
      expect(funcs.addItemToFront([97, 100, 80, 55, 72, 94], 'Hello')).toEqual([
        'Hello',
        97,
        100,
        80,
  ...
  describe('wordsToSentence(words)', () => {
    it('should return a string that has all of the words from the array separated by spaces', () => {
      expect(
        funcs.wordsToSentence(['LambdaSchool', 'JavaScript', 'Class'])
      ).toBe('LambdaSchool JavaScript Class');
