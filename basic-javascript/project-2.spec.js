...
it('return the larger of the two numbers', () => {
   expect(funcs.getBiggest(9, 8)).toBe(9);
    expect(funcs.getBiggest(10, 10)).toBe(10);
    expect(funcs.getBiggest(9, 10)).toBe(10);
   
});
it('returns a greeting with a language string', () => {
...
it('should return true for an integer else return false', () => {
    expect(funcs.isInteger(9.99)).toBe(false);
...
it('should return first item of an array', () => {
   ...
   expect(funcs.returnFirst(['string', 1])).toBe('string');
  expect(funcs.returnFirst(['str1', 'str2', true])).toBe('str1'); 
});
it('should return last item of an array', () => {
    expect(funcs.returnLast([1, 2, 3])).toBe(3);
   expect(funcs.returnLast([])).toBe(undefined);
   expect(funcs.returnLast(['str1', 'str2', true])).toBe(true);
