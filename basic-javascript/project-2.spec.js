...
describe('project-2', () => {
    ...
    it('should return the largest of the two', () => {
    ...
    it('should return true if the array includes the object', () => {
