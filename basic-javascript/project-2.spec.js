...
describe('getBiggest', () => {
    it('should return the bigger nubmer', () => {
...
describe('isInRange', () => {
    ...
    it('should return false if number is not between 20 and 50', () => {
        expect(funcs.isInRange(15)).toEqual(false);
    });
});

describe('isInteger', () => {
    it('should return true if arg is a integer', () => {
        expect(funcs.isInteger(10)).toBe(true);
    });
    it('should return false if arg is not a integer', () => {
...
describe('fizzbuzz', () => {
   ...
   it('should return the number passed if its not divisible by 3 or 5', () => {
