...
describe('Project-1 Functions', () => {
  describe('`multiplyByTen`', () => {
    ...
    // begin here
    it('should return ten times the input', () => {
      const multiplyByTen = funcs.multiplyByTen;
      assert.equal(multiplyByTen(2), 20);
    });
    it('should return an output with type: number', () => {
      const multiplyByTen = funcs.multiplyByTen;
  ...
  describe('`subtractFive`', () => {
    ...
    it('should return 5 less than the input', () => {
      const subtractFive = funcs.subtractFive;
      assert.equal(subtractFive(10), 5);
    });
    it('should return an output with type: number', () => {
      const subtractFive = funcs.subtractFive;
      assert.typeOf(subtractFive(8), 'number');
    });
  });
