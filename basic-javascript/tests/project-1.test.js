...
describe('Project-1 Functions', () => {
  ...
  describe('`subtractFive`', () => {
    ...
    it('should return -3 when n = 2', () => {
      const subtractFive = funcs.subtractFive;
      const n = 2;
      assert.equal(subtractFive(n), n - 5);
    });
    it('should return -8 when n = -3', () => {
      const subtractFive = funcs.subtractFive;
      const n = -3;
      assert.equal(subtractFive(n), n - 5);
    });
  ...
  describe('`areSameLength`', () => {
    ...
    it('should return true when strings are same length', () => {
      const areSameLength = funcs.areSameLength;
      assert.isTrue(areSameLength('abc', 'gha'), 'abc and gha are the same length');
    });
  });
  ...
  describe('`areEqual`', () => {
    ...
    it('should return true when nums are equal', () => {
      const areEqual = funcs.areEqual;
      assert.isTrue(areEqual(3, 3), '3 is equal to 3');
    });
    it('should return false when nums are not equal', () => {
      const areEqual = funcs.areEqual;
      assert.isFalse(areEqual(3, 4), '3 is not equal to 4');
