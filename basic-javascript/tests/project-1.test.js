...
describe('Project-1 Functions', () => {
  ...
  describe('`areSameLength`', () => {
    ...
    it('should return true if length are the same', () => {
      const areSameLength = funcs.areSameLength;
  ...
  describe('`getRemainder`', () => {
    ...
    it('should return remainder of two numbers being divide', () => {
      const getRemainder = funcs.getRemainder;
  ...
  describe('`combineNames`', () => {
    ...
    it('should combine two name strings', () => {
      const combineNames = funcs.combineNames;
      assert.equal(combineNames('christian', 'franco'), 'christian franco');
    });
  });
  ...
  describe('`getGreeting`', () => {
    ...
    it('should return a greeting to a user', () => {
      const getGreeting = funcs.getGreeting;
      assert.equal(getGreeting('christian'), 'Hello christian!');
    });
  });
