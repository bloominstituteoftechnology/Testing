...
describe('Project Two', () => {
    ...
    describe('addNumbers', () => { // array[number > number
        ...
        it('should return a number', () => {
            const addNumbers = funcs.addNumbers;
            const temp = [1,2,3];
            assert.isNumber(addNumbers(temp), 'Should return a numeric value.');
        });

        it('should return 6', () => {
            const addNumbers = funcs.addNumbers;
            const temp = [1,2,3];
            assert.equal(addNumbers(temp), 6, 'should return 6');
        });
    });

    describe('averageTestScore', () => { // array[number > number
        ...
        it('should return a number', () => {
            const averageTestScore = funcs.averageTestScore;
            const temp = [1,2,3];
            assert.isNumber(averageTestScore(temp), 'Should return a numeric value.');
        });
    ...
    describe('largestNumber', () => { // array[number > number
        it('largestNumber should be a function', () => {
            const largestNumber = funcs.largestNumber;
            assert.isFunction(largestNumber, 'largestNumber is a function');
        });

        it('should return a number', () => {
            const largestNumber = funcs.largestNumber;
            const temp = [1,2,3];
            assert.isNumber(largestNumber(temp), 'Should return a numeric value.');
        });

        it('should return 20', () => {
            const largestNumber = funcs.largestNumber;
            const temp = [1,20,3];
            assert.equal(largestNumber(temp), 20, 'should return 20');
        });
    });
